export default {
    settings: {
      ...
      linuxdo: {
        ...
        description: 'Configure LinuxDo Connect OAuth for Gateway Bot end-user login',
      ...
      dingtalk: {
        ...
        description: 'Configure DingTalk OAuth for Gateway Bot end-user login',
      ...
      scheduling: {
        ...
        accountSchedulingThresholdsDescription: 'When an account\'s current native usage window (OpenAI Codex/Anthropic session, or Grok request/token utilization) reaches this percent, Gateway Bot temporarily removes it from scheduling until the window resets. Use 100 to disable.',
      ...
      upstreamBillingProbe: {
        ...
        description: 'Periodically retrieve rates declared by upstream Gateway Bot sites. Account rates change only when the separate sync switch is enabled.',
      ...
      site: {
        ...
        siteName: 'Site Name',
        siteNamePlaceholder: 'Gateway Bot',
        siteNameHint: 'Displayed in emails and page titles',
        siteSubtitle: 'Site Subtitle',
        siteSubtitlePlaceholder: 'AI access within reach',
      ...
      payment: {
        ...
        easypayCustomMethodsHint: 'Add provider-specific methods supported by this EasyPay endpoint. The payment type is stored on Gateway Bot orders; the upstream type is sent as EasyPay type.',
      ...
      smtp: {
        ...
        fromName: 'From Name',
        fromNamePlaceholder: 'Gateway Bot',
        useTls: 'Use TLS',
