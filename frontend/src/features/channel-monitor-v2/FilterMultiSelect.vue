...
.select-trigger {
  ...
  @apply rounded-[6px] px-4 py-2.5 text-sm;
...
.filter-dropdown {
  @apply w-max min-w-[200px] max-h-[min(50vh,360px)] overflow-y-auto rounded-[6px] border border-gray-200 bg-white shadow-lg dark:border-dark-600 dark:bg-dark-800;
}
