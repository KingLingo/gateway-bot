<template>
  <BaseDialog :show="show" :title="t('admin.promptAudit.events.filterDeleteDialogTitle')" width="wide" @close="$emit('close')">
    <div class="space-y-5 text-sm">
      ...
      <details class="rounded-[6px] border border-gray-200 px-4 py-3 dark:border-dark-700/60" data-test="more-conditions">
      ...
      <div v-if="preview" class="rounded-[6px] border border-red-200 bg-red-50/60 px-4 py-3 dark:border-red-900/60 dark:bg-red-950/20" data-test="delete-preview-result">
      ...
      <p v-else class="rounded-[6px] border border-dashed border-gray-300 px-4 py-3 text-xs text-gray-500 dark:border-dark-600 dark:text-dark-400" data-test="delete-preview-empty">
