    ...
    <div class="space-y-6">
      ...
      <template v-else-if="detail">
        ...
        <div class="card p-6">
          ...
          <div class="mt-5 grid gap-4 md:grid-cols-2">
            <div class="space-y-2">
              ...
              <div class="flex flex-col items-stretch gap-2 rounded-[6px] border border-gray-200 bg-gray-50 px-3 py-2 dark:border-dark-700 dark:bg-dark-900 sm:flex-row sm:items-center">
          ...
          <div class="mt-5 rounded-[6px] border border-primary-200 bg-primary-50 p-4 dark:border-primary-900/40 dark:bg-primary-900/20">
        ...
        <div class="card p-6">
          ...
          <div v-if="detail.invitees.length === 0" class="mt-4 rounded-[6px] border border-dashed border-gray-300 p-6 text-center text-sm text-gray-500 dark:border-dark-700 dark:text-dark-400">
