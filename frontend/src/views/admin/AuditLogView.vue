  ...
  <AppLayout>
    ...
    >
      ...
      <div v-else-if="detail" class="space-y-5 py-2">
        ...
        <div class="rounded-[6px] border border-gray-200 bg-gray-50/60 p-5 dark:border-dark-700 dark:bg-dark-900/60">
        ...
        <section>
          ...
          <div class="break-all rounded-[6px] bg-gray-50 p-3 font-mono text-xs leading-relaxed text-gray-600 dark:bg-dark-900 dark:text-gray-400">
            {{ detail.user_agent || '—' }}
          </div>
        </section>
        ...
        <section v-if="detail.request_body">
          ...
          <pre class="max-h-72 overflow-auto rounded-[6px] bg-gray-50 p-4 font-mono text-xs leading-relaxed text-gray-600 dark:bg-dark-900 dark:text-gray-400">{{ prettyBody(detail.request_body) }}</pre>
        </section>
        ...
        <section v-if="detail.extra && Object.keys(detail.extra).length">
          ...
          <pre class="max-h-48 overflow-auto rounded-[6px] bg-gray-50 p-4 font-mono text-xs leading-relaxed text-gray-600 dark:bg-dark-900 dark:text-gray-400">{{ JSON.stringify(detail.extra, null, 2) }}</pre>
        </section>
      </div>
    </BaseDialog>
