  ...
  <BaseDialog :show="show" :title="title" width="full" :close-on-click-outside="true" @close="close">
    ...
    <div v-else class="space-y-6 p-6">
      ...
      <div class="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
        ...
        <div v-if="detail.api_key_prefix" class="rounded-[6px] bg-gray-50 p-4 dark:bg-dark-900">
      ...
      <div class="rounded-[6px] bg-gray-50 p-6 dark:bg-dark-900">
        ...
        <pre class="mt-4 max-h-[520px] overflow-auto rounded-[6px] border border-gray-200 bg-white p-4 text-xs text-gray-800 dark:border-dark-700 dark:bg-dark-800 dark:text-gray-100"><code>{{ prettyJSON(primaryResponseBody || '') }}</code></pre>
      </div>

      <!-- Upstream errors list (only for request errors) -->
      <div v-if="showUpstreamList" class="rounded-[6px] bg-gray-50 p-6 dark:bg-dark-900">
        ...
        <div v-else class="mt-4 space-y-3">
          <div
            ...
            :key="ev.id"
            class="rounded-[6px] border border-gray-200 bg-white p-4 dark:border-dark-700 dark:bg-dark-800"
          >
            <div class="flex flex-wrap items-center justify-between gap-2">
            ...
            <pre
              ...
              class="mt-3 max-h-[240px] overflow-auto rounded-[6px] border border-gray-200 bg-gray-50 p-3 text-xs text-gray-800 dark:border-dark-700 dark:bg-dark-900 dark:text-gray-100"
