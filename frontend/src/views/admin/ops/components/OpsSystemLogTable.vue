...
<template>
  <section class="rounded-[6px] border border-gray-200 bg-white p-4 shadow-sm dark:border-dark-700 dark:bg-dark-900/60">
    ...
    <div class="mb-4 rounded-[6px] border border-gray-200 bg-gray-50 p-3 dark:border-dark-700 dark:bg-dark-800/70">
    ...
    <div class="overflow-hidden rounded-[6px] border border-gray-200 dark:border-dark-700">
