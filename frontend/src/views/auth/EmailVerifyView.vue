  ...
  <AuthLayout>
    <div class="space-y-6">
      ...
      <div
        ...
        class="rounded-[6px] border border-amber-200 bg-amber-50 p-4 dark:border-amber-800/50 dark:bg-amber-900/20"
      >
      ...
      <form v-else @submit.prevent="handleVerify" class="space-y-5">
        ...
        <div
          v-if="codeSent"
          class="rounded-[6px] border border-green-200 bg-green-50 p-4 dark:border-green-800/50 dark:bg-green-900/20"
        >
          <div class="flex items-start gap-3">
            <div class="flex-shrink-0">
...
const siteName = ref<string>('Gateway Bot')
...
onMounted(async () => {
  ...
  try {
    ...
    siteName.value = settings.site_name || 'Gateway Bot'
