  ...
  <AuthLayout>
    <div class="space-y-6">
      ...
      <div v-if="isInvalidLink" class="space-y-6">
        <div class="rounded-[6px] border border-amber-200 bg-amber-50 p-6 dark:border-amber-800/50 dark:bg-amber-900/20">
      ...
      <div v-else-if="isSuccess" class="space-y-6">
        <div class="rounded-[6px] border border-green-200 bg-green-50 p-6 dark:border-green-800/50 dark:bg-green-900/20">
          <div class="flex flex-col items-center gap-4 text-center">
