  ...
  >
    <div class="w-full max-w-2xl">
      ...
      <div class="mb-8 text-center">
        <div
          class="mb-4 inline-flex h-16 w-16 items-center justify-center rounded-[6px] bg-gradient-to-br from-primary-500 to-primary-600 shadow-lg"
        >
      ...
      <!-- Step Content -->
      <div class="rounded-[6px] bg-white p-8 shadow-xl dark:bg-dark-800">
        <!-- Step 1: Database -->
        <div v-if="currentStep === 0" class="space-y-6">
          ...
          <div class="flex items-center justify-between rounded-[6px] border border-gray-200 p-3 dark:border-dark-700">
            <div>
        ...
        <div v-if="currentStep === 3" class="space-y-6">
          ...
          <div class="space-y-4">
            <div class="rounded-[6px] bg-gray-50 p-4 dark:bg-dark-700">
        ...
        <div
          v-if="errorMessage"
          class="mt-6 rounded-[6px] border border-red-200 bg-red-50 p-4 dark:border-red-800/50 dark:bg-red-900/20"
        >
        ...
        <div
          v-if="installSuccess"
          class="mt-6 rounded-[6px] border border-green-200 bg-green-50 p-4 dark:border-green-800/50 dark:bg-green-900/20"
        >
          <div class="flex items-start gap-3">
            <svg
              v-if="!serviceReady"
