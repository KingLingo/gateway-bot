  ...
  <div>
    ...
    >
      <div
        v-for="i in 6"
        :key="i"
        class="p-5 rounded-[6px] min-h-[280px] bg-white/70 dark:bg-dark-800/60 border border-gray-200/80 dark:border-dark-700/70 animate-pulse"
      >
        <div class="flex items-start gap-3">
          <div class="w-9 h-9 rounded-[6px] bg-gray-200 dark:bg-dark-700"></div>
        ...
        <div class="mt-5 grid grid-cols-2 gap-2">
          <div class="h-16 rounded-[6px] bg-gray-100 dark:bg-dark-900/40"></div>
          <div class="h-16 rounded-[6px] bg-gray-100 dark:bg-dark-900/40"></div>
        </div>
