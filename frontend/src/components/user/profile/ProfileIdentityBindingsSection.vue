        ...
        <div class="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
          <div class="flex min-w-0 flex-1 items-start gap-4">
            <div
              ...
              class="flex h-11 w-11 shrink-0 items-center justify-center rounded-[6px] text-sm font-semibold"
            >
              <Icon
...
const rowClass = computed(() =>
  props.embedded
    ? compact.value
      ? 'rounded-[6px] border border-gray-100 bg-white p-4 shadow-sm dark:border-dark-700 dark:bg-dark-900/40'
      : 'rounded-[6px] border border-gray-100 bg-gray-50/70 p-4 dark:border-dark-700 dark:bg-dark-900/30'
    : 'px-6 py-5'
)
