<template>
  <div
    :class="[
      'group relative flex flex-col overflow-hidden rounded-[6px] border transition-all',
  ...
  >
    ...
    <div class="flex flex-1 flex-col p-4">
      ...
      <button
        type="button"
        :class="['w-full rounded-[6px] py-2.5 text-sm font-semibold transition-all active:scale-[0.98]', btnClass]"
