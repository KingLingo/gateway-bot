<template>
  ...
  >
    ...
    <div class="sidebar-header" :class="{ 'sidebar-header-collapsed': sidebarCollapsed }">
      <router-link
        :to="homePath"
        class="sidebar-logo flex items-center justify-center transition-opacity hover:opacity-85"
        aria-label="Gateway Bot"
        @click="handleMenuItemClick(homePath)"
      >
        <GatewayBrand :logo="settingsLoaded ? siteLogo : ''" compact mark-class="h-9 w-9" />
      </router-link>
...
import {
  PhArrowsClockwise as RechargeSubscriptionIcon,
  PhBell as BellIcon,
  PhBroadcast as SignalIcon,
  PhCaretDoubleLeft as ChevronDoubleLeftIcon,
  PhCaretDoubleRight as ChevronDoubleRightIcon,
  PhCaretDown as ChevronDownIcon,
  PhChartBar as ChartIcon,
  PhClipboardText as OrderListIcon,
  PhCreditCard as CreditCardIcon,
  PhFileText as OrderIcon,
  PhFolder as FolderIcon,
  PhGear as CogIcon,
  PhGift as GiftIcon,
  PhGlobeSimple as GlobeIcon,
  PhHardDrives as ServerIcon,
  PhImages as BatchImageIcon,
  PhKey as KeyIcon,
  PhMoon as MoonIcon,
  PhShieldCheck as ShieldIcon,
  PhSquaresFour as DashboardIcon,
  PhStack as ChannelIcon,
  PhSun as SunIcon,
  PhTag as PriceTagIcon,
  PhTicket as TicketIcon,
  PhUser as UserIcon,
