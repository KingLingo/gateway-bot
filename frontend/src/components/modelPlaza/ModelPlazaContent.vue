<template>
  <div class="space-y-5">
    ...
    <div
      ...
      class="plaza-description rounded-[6px] border border-gray-100 bg-white px-5 py-4 text-sm shadow-card dark:border-dark-700/50 dark:bg-dark-800/50"
    ...
    <div
      v-else-if="error"
      class="rounded-[6px] border border-red-200 bg-red-50 px-5 py-8 text-center text-sm text-red-600 dark:border-red-500/30 dark:bg-red-500/10 dark:text-red-300"
    >
