<template>
  <BaseDialog :show="show" :title="t('admin.users.groupConfig')" width="wide" @close="$emit('close')">
    <div v-if="user" class="space-y-6">
      <!-- 用户信息头部 -->
      <div class="flex items-center gap-4 rounded-[6px] bg-gradient-to-r from-primary-50 to-primary-100 p-5 dark:from-primary-900/30 dark:to-primary-800/20">
        ...
        <div v-if="exclusiveGroups.length > 0">
          ...
          <div class="grid gap-3">
            <div
              ...
              :key="config.groupId"
              class="group relative overflow-hidden rounded-[6px] border-2 p-4 transition-all duration-200"
        ...
        <div v-if="publicGroups.length > 0">
          ...
          <div class="grid gap-3">
            <div
              ...
              :key="config.groupId"
              class="relative overflow-hidden rounded-[6px] border-2 border-green-200 bg-green-50/50 p-4 dark:border-green-800/50 dark:bg-green-900/10"
            >
              <div class="flex items-center gap-4">
                <!-- 复选框（禁用状态） -->
                <div class="flex-shrink-0">
