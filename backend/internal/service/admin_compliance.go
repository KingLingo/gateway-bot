...
const (
	...
	AdminComplianceDocumentURLZH  = "https://github.com/KingLingo/gateway-bot/blob/gateway-bot/docs/legal/admin-compliance.zh.md"
	AdminComplianceDocumentURLEN  = "https://github.com/KingLingo/gateway-bot/blob/gateway-bot/docs/legal/admin-compliance.en.md"
	AdminComplianceAckPhraseZH    = "我已阅读、理解并同意 Gateway Bot 部署与运营合规承诺"
	AdminComplianceAckPhraseEN    = "I have read, understood, and agree to the Gateway Bot Deployment and Operation Compliance Commitment"
